...
mkdir -p "$APP/Contents/MacOS" "$APP/Contents/Library/LaunchServices" "$APP/Contents/Library/LaunchDaemons" "$APP/Contents/Resources/OpenConnect" "$APP/Contents/Resources/ThirdParty"
cp "$BIN_DIR/XDVPN" "$APP/Contents/MacOS/XDVPN"
cp "$BIN_DIR/XDVPNHelper" "$APP/Contents/Library/LaunchServices/com.xd.vpn.helper"
cp Resources/com.xd.vpn.helper.plist "$APP/Contents/Library/LaunchDaemons/"
...
xdvpn_verify_architectures "$APP/Contents/Library/LaunchServices/com.xd.vpn.helper" "$ARCH"
...
xdvpn_sign com.xd.vpn.helper "$APP/Contents/Library/LaunchServices/com.xd.vpn.helper"
